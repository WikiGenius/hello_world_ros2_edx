...
void ROSConveyorBeltPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->controlService_ = this->rosnode_->create_service<hrwros_gazebo::srv::ConveyorBeltControl>(
...
bool ROSConveyorBeltPlugin::OnControlCommand(
  const std::shared_ptr<hrwros_gazebo::srv::ConveyorBeltControl::Request> req,
  std::shared_ptr<hrwros_gazebo::srv::ConveyorBeltControl::Response> res)
{
