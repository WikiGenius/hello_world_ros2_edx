...
#include "hrwros_interface/msg/vacuum_gripper_state.hpp"
...
namespace gazebo
{
  ...
  struct ROSVacuumGripperPluginPrivate
  {
    ...
    public: rclcpp::Publisher<hrwros_interface::msg::VacuumGripperState>::SharedPtr statePub;

    /// \brief Receives service calls to control the gripper.
    public: rclcpp::Service<hrwros_interface::srv::VacuumGripperControl>::SharedPtr controlService;
  };
}
...
void ROSVacuumGripperPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->controlService = this->dataPtr->rosnode->create_service<hrwros_interface::srv::VacuumGripperControl>(
  ...
  this->dataPtr->statePub = this->dataPtr->rosnode->create_publisher<hrwros_interface::msg::VacuumGripperState>(stateTopic, 10);
}
...
bool ROSVacuumGripperPlugin::OnGripperControl(
  const std::shared_ptr<hrwros_interface::srv::VacuumGripperControl::Request> request,
...
{
  auto msg = hrwros_interface::msg::VacuumGripperState();
