...
namespace gazebo
{
  ...
  class ROSProximityRayPlugin : public ProximityRayPlugin
  {
    ...
    protected: rclcpp::Publisher<hrwros_interface::msg::Proximity>::SharedPtr statePub;

    /// \brief ROS 2 publisher for the sensor state changes
    protected: rclcpp::Publisher<hrwros_interface::msg::Proximity>::SharedPtr stateChangePub;

    /// \brief ROS 2 message for the sensor state
    protected: hrwros_interface::msg::Proximity state_msg;
