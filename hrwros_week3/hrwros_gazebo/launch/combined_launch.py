...
def generate_launch_description():
    ...
    gzserver_launch, gzclient_launch = helper_combination.load_gazebo_launch(gzserver_launch_path, gzclient_launch_path, world_path, extra_gazebo_args, paused, debug)
    ...
    spawn_turtlebot = helper_combination.execute_delayed_process(DELAY_SPAWN_TURTLEBOT, "hrwros_gazebo", "spawn_turtlebot.launch.py")
    bringup_launch = helper_combination.execute_delayed_process(DELAY_SPAWN_NAVIGATION, "hrwros_nav", "bringup_launch.py")
    ...
    twist_mux_node = helper_combination.create_twist_mux_node(use_sim_time, config_topics_arg, cmd_vel_out_arg)
